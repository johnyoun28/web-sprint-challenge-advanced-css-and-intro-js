...
1. How would you describe acessibility on the web to someone new to programming?
   Accessibility is important because your website needs to have all the functions for every device such as mobile, tablets, desktop, etc. There are many people with different conditions may need other resources in order to view your site.

2. Talk about 3 different things you can do to ensure your website is accessible.
   1 - responsive to mobile/tablet or other devices
   2 - using alt texts for any images on your page
   3 - using percentages to make your website scalable

3. How would you explain the concept of a variable to someone new to programming?
   Think of a variable as a box container that has data stored inside of it.

4. What is the purpose of using functions in code?
   Functions are important because you are able to execute/call it whenever you want throughout all your code after making one.
